...
# User generation
No_MNO=6
N_UE_s=[20,19,19,18,20,18]
ReRate_MNO=[15,16,16,16,15,16]
# No_MNO=5
...
rate_vt=[ReRate_MNO[1]*ones(N_UE_s[1],1); ReRate_MNO[2]*ones(N_UE_s[2],1); ReRate_MNO[3]*ones(N_UE_s[3],1);
          ReRate_MNO[4]*ones(N_UE_s[4],1); ReRate_MNO[5]*ones(N_UE_s[5],1); ReRate_MNO[6]*ones(N_UE_s[6],1)]
